...
class AddTodo extends Component {
  ...
  // The handleDueDate function updates the react state with what the user inputs for the desired due date of the todo item.
  // This update/change is donne when the user inputs or changes the due date for a to do list item they plan to add.
